...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview {{Request::is('Accountant/projects/*') ? 'active' : ''}}">
				<a href="#">
				...
				<ul class="treeview-menu">
					<li class="{{Request::path()=='Accountant/projects/projectlist' ? 'active' : ''}}"><a href="{{url('Accountant\projects\projectlist')}}"><i class="fa fa-circle-o"></i>Project List</a></li>
