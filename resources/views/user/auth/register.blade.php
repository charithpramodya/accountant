                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/user/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('organzation') ? ' has-error' : '' }}">
                            <label for="organzation" class="col-md-4 control-label">Organzation</label>

                            <div class="col-md-6">
                                <input id="organzation" type="text" class="form-control" name="organzation" value="{{ old('organzation') }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('bustype') ? ' has-error' : '' }}">
                            <label for="bustype" class="col-md-4 control-label">Type of Business</label>

                            <div class="col-md-6">
                                <input id="bustype" type="text" class="form-control" name="bustype" value="{{ old('bustype') }}" autofocus>
